...
sender_accounts = [
    {"email": "abhaypadavi@gmail.com", "app_password": "tvspstknyxtjitha"}
]
...
# I’ve developed a strong foundation in PL/SQL, Python, SQL, HTML, CSS, ASP.NET, C#, and Linux, and I’ve applied these through hands-on job simulations offered by Forage, gaining valuable exposure to real-world business scenarios.<br>
# Currently, I’m working as an intern at Hindustan Aeronautics Limited, where I'm contributing to backend Oracle databases — maintaining data, building dashboards, and optimizing performance to handle client requests more efficiently.<br>
# I’d love the opportunity to connect and learn more about your team. Would you be open to a quick chat to explore any opportunities that might align with my background?<br>
# I’ve attached my resume here for your reference:<br>
# <a href="{tracked_link}">Resume Link</a> (Google Drive: <a href="{drive_link}">{drive_link}</a>)<br><br>
# Thank you so much for your time — I’d truly appreciate any insights or guidance you can share.<br><br>
# Looking forward to hearing from you!<br><br>
# Warm regards,<br>
# Abhay Padavi<br>
# <a href="{linkedin_url}">LinkedIn</a><br>
# +91-XXXXXXXXXX<br>
# abhaypadavi@gmail.com<br>
...
Currently, I’m working as an intern at Hindustan Aeronautics Limited, where I'm contributing to backend Oracle databases — maintaining data, building dashboards, and optimizing performance to handle client requests more efficiently.<br>
I’d love the opportunity to connect and learn more about your team. Would you be open to a quick chat to explore any opportunities that might align with my background?<br>
I’ve attached my resume here for your reference: <a href="{tracked_link}">Click here to view my resume</a>
Thank you so much for your time — I’d truly appreciate any insights or guidance you can share.
Looking forward to hearing from you!
Warm regards,
Abhay Padavi
<a href="{linkedin_url}">LinkedIn</a>
<br>+91-XXXXXXXXXX<br>abhaypadavi@gmail.com<br>
<img src="{open_pixel_url}" alt="" width="1" height="1" style="display:none;">
</body></html>"""
...
def send_email(from_account, to_email, name):
    ...
    while attempt <= MAX_RETRIES and not stop_event.is_set():
        ...
        try:
            ...
            tracked_link = f"{TRACKING_SERVER}/redirect?id={tracking_id}&email={to_email}"
